...
const sampleData = [
  { name: "City A, State", actual: 1200000, anterior: 700000 },
  { name: "City B, State", actual: 600000, anterior: 400000 },
  { name: "City C, State", actual: 950000, anterior: 450000 },
  { name: "City D, State", actual: 850000, anterior: 800000 },
  { name: "City E, State", actual: 300000, anterior: 500000 },
];

const TopVentasComparadoChart: React.FC = () => {
