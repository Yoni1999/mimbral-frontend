...
import { Filters } from "./HeaderDrawerProducto";
...
const VentasChart: React.FC<Props> = ({ filtros }) => {
    ...
    <ResponsiveContainer width="100%" height={height}>
      <LineChart data={data}>
        ...
        {[
          ...
          { key: "falabella", color: "#E0A229", name: "Falabella" },
          { key: "empresas", color: "#45914b", name: "Empresas" },
          { key: "vitex", color: "#9583ff", name: "Vtex" },
          { key: "balmaceda", color: "#BF5105", name: "Balmaceda" },
        ].map((line) => (
          <Line
            key={line.key}
            type="monotone"
  ...
  return (
    ...
    <Box
      sx={{
        width: "100%",
        p: 0, // o p: 2 si necesitas espacio interno
